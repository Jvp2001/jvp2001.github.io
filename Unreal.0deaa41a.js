...
})({"eRDkj":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "658543340deaa41a";
"use strict";
...
},{}],"3kNHm":[function(require,module,exports) {
...
parcelHelpers.export(exports, "defaultPageVariables", ()=>defaultPageVariables);
parcelHelpers.export(exports, "enginePagesConfig", ()=>enginePagesConfig);
const config = {
    titleHeading: {
        content: "Joshua Petersen"
    }
};
const defaultPageVariables = {
    gitHubPageURL: "https://github.com/jvp2001",
    gitHubWebPagesUrl: "https://jvp2001/jvp2001.github.io/dist",
...
function createProjectItemElement(vars, element) {
    if (isOfType(element, "showControls")) {
        ...
        if (element.maximiseOnClick) videoTag.addEventListener("click", async (_)=>{
    ...
    if (isOfType(element, "style")) {
        ...
        return imgTag;
    } else throw new Error("Unrecognised ProjectElement type");
}
function createProjectItem(vars, itemInfo) {
...
var fscreen = {
    ...
    addEventListener: function(type, handler1, options) {
        return document.addEventListener(vendor[key[type]], handler1, options);
    },
    removeEventListener: function(type, handler1, options) {
        return document.removeEventListener(vendor[key[type]], handler1, options);
    },
...
exports.default = fscreen;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eRDkj","3kNHm"], "3kNHm", "parcelRequire94c2")

//# sourceMappingURL=Unreal.0deaa41a.js.map
